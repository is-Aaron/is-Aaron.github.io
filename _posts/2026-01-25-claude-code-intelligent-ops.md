...
```mermaid
graph TB
    subgraph INPUT[" ━━━━━━━━━━━━━━━━━━━━ 输入层：为 Claude Code 提供三大核心要素 ━━━━━━━━━━━━━━━━━━━━ "]
        direction TB
...
graph TB
    ...
    subgraph ENGINE[" ━━━━━━━━━━━━ Claude 上下文引擎 ━━━━━━━━━━━━ "]
        ...
        WINDOW["📊 大规模上下文窗口<br/>━━━━━━━━━━━━━━━━━━<br/>智能组合各层内容<br/>形成完整的服务理解<br/><br/>容量管理策略：<br/>· L1: 30-40% (核心源码)<br/>· L2: 20-30% (依赖代码)<br/>· L3: 10-20% (历史知识)<br/>· L4: 20-30% (运行数据)"]
...
| **流处理**   | Kafka + Flink          | Pulsar, RabbitMQ   |
